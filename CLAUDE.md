...
**Core Value:** A new project generated from this preset is **architecture-safe by machine**: zero gate-covered architecture violations and zero unapproved T3 (high-risk) changes can reach the main branch — quality does not depend on individual reviewers or agent prompting.
